...
def test1():
    print("RUNNING BO for 1 dimensional function with log info:")
...
def test2():
    ...
    print("e^3 is joint probability of the same event for 3 independent runs")
    print("(that's why we need more runs)")
