...
Bayesian Optimization (BO) is global optimization for expensive black-box functions. This implementation of BO in python is created for author's [diploma thesis]() (not in english, note that this code is updated). 
